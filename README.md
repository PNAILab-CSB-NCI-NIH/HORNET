...
See [here](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/DynamicFitting/README.md) for detailed explanations for how to perform Dynamic Fitting calculations using CafeMol. We strongly advise running the Dynamic Fitting using a range of kappa values (e.g., 2 to 24, in increments of 2 or 4).
...
All Python executable scripts can be found in [scripts](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/scripts).
...
Note: Example .ts and .txt files associated with the TUTORIAL data are provided in [TUTORIAL](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/data/TUTORIAL): output_k14.ts, output_k22.ts, en_allk14.txt, and en_allk22.txt.

#### 3. Run the [prepare_inputs.py](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/scripts/prepare_inputs.py)
...
Note: Example .csv files associated with the TUTORIAL data are provided in [TUTORIAL](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/data/TUTORIAL): bases_k14.csv and bases_k22.csv.

First, cd into the [scripts](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/scripts) directory.
...
To select the top cohort structures using unsupervised learning, one just needs to run [uml_analysis.py](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/scripts/uml_analysis.py) as follows:
...
- model-location: Path of the trained model to be used. If using HORNET's trained model, the location is [hornet](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/models/hornet). For information on using other trained models, see Section V. below.
...
A modified example script with associated input files can be found in the [outpdb](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/utilities/outpdb/) directory, and the required .dcd file can be obtained [here](https://home.ccr.cancer.gov/csb/pnai/data/HorNet/tutorial/k30.dcd). With all required files in the directory, the script can be run as follows:
...
For converting coarse-grained bead-models to all-atom coordinates, the utility [cg2aa](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/utilities/cg2aa) has been provided, which requires the package [XPLOR-NIH](https://nmr.cit.nih.gov/xplor-nih/) (free for academic users). The [cg2aa](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/utilities/cg2aa) directory contains example scripts, input files, and its own README file for using this utility.


## V. Training a Model

If one wants to train a model using data other than those used to train HORNET, the [train.py](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/scripts/train.py) script has been provided. Example data files for training and validation are also provided in [TUTORIAL](https://github.com/PNAI-CSB-NCI-NIH/HORNET/tree/main/data/TUTORIAL): 'train_sample1.csv', 'train_sample2.csv' and 'validation_sample.csv'.
